...
@section('title',"تسجيل أمر شراء")
@section('icon',"bi bi-coin mx-1")
      ...
      <div class="container">
        <div class="data-info row p-0 m-0 w-100 flex-row-reverse justify-content-center align-items-center">
          <div class="data-text col-4 my-2 text-center mb-3">
            <label class="text-light fs-4 mb-2">رقم الفاتورة</label>
            <input class="form-control w-100 text-center mx-auto" value="" name="ReceiptNumber" value="{{old('ReceiptNumber')}}" type="text" placeholder="">
          </div>
          <div class="data-text col-4 my-2 text-center mb-3">
          ...
          <div class="data-text col-4 my-2 text-center mb-3">
            <label class="text-light fs-4 mb-2">سعر القطعة</label>
            <input class="form-control w-100 text-center mx-auto" value="" name="AmountPiece" value="{{old('AmountPiece')}}" type="text" placeholder="">
          </div>
          <div class="data-text col-4 my-2 text-center mb-3">
            <label class="text-light fs-4 mb-2">الفرع</label>
            <select class="form-control w-100 text-center mx-auto" name="BranchName" id="">
