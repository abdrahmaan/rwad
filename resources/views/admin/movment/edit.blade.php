...
@section('title',"تعديل حركة يومية")
...
@section('content')
    ...
    <form action="/admin/movments/{{$Movment->id}}" method="post" enctype="multipart/form-data">
      @csrf
      @method("PUT")
      ...
      <div class="container">
        <div class="data-info row p-0 m-0 w-100 flex-row-reverse justify-content-center align-items-center">
          <div class="data-text col-4 my-2 text-center mb-3">
            ...
            <input id="name" class="form-control w-100 text-center mx-auto" name="Tabashery" type="text" value="{{$Movment->Tabashery}}" placeholder="طباشيرى">
          </div>
          <div class="data-text col-4 my-2 text-center mb-3">
            <label class="text-light fs-4 mb-2">رقم اللوحة</label>
            <input class="form-control w-100 text-center mx-auto" readonly name="PlateNumber" value="{{$Movment->PlateNumber}}" type="text" placeholder="">
          </div>
          <div class="data-text col-4 my-2 text-center mb-3">
            <label class="text-light fs-4 mb-2">نوع السيارة</label>
            <input class="form-control w-100 text-center mx-auto" readonly name="CarType" value="{{$Movment->CarType}}" type="text" placeholder="">
          </div>

          <div class="data-text col-4 my-2 text-center mb-3">
            <label class="text-light fs-4 mb-2">عداد الخروج</label>
            <input class="form-control w-100 text-center mx-auto" readonly name="StartCounter" value="{{$Movment->StartCounter}}" type="number" placeholder="">
          </div>
          <div class="data-text col-4 my-2 text-center mb-3">
            <label class="text-light fs-4 mb-2">عداد الدخول</label>
            <input class="form-control w-100 text-center mx-auto" hidden readonly name="EndCounterPrev" value="{{$Movment->EndCounter}}" type="number" placeholder="">
            <input class="form-control w-100 text-center mx-auto" name="EndCounter" value="{{$Movment->EndCounter}}" type="number" placeholder="">
          </div>
          <div class="data-text col-4 my-2 text-center mb-3">
            <label class="text-light fs-4 mb-2">الفرق</label>
            <input class="form-control w-100 text-center mx-auto" readonly name="Diff" value="" type="number" placeholder="">
          </div>
          <div class="data-text col-4 my-2 text-center mb-3">
            <label class="text-light fs-4 mb-2">الفرع</label>
            <input class="form-control w-100 text-center mx-auto" readonly name="BranchName" value="{{$Movment->BranchName}}" type="text" placeholder="">
          </div>
...
function Events(){
  ...
  inputs[7].addEventListener("keydown",(e)=>{
    ...
    newInputs[8].value = Number(e.target.value) - Number(newInputs[5].value);
